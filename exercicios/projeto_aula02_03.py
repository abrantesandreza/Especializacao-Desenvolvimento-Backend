...
while True:
    ...
    match opcao:
        ...
        case 2:
            ...
            print(f'{datetime.now()} - Usuário pesquisado com sucesso!')
        case 3:
        ...
        case 6:
            ...
            print(f'{datetime.now()} - Usuário salvo com sucesso!')
        case 7:
            lista_nomes = projeto_funcoes.ler_arquivo()
            print(f'{datetime.now()} - Usuário persistido com sucesso!')
        case 0:
            print(f'Programa finalizando...')
            print(f'{datetime.now()} - Usuário finalizou o programa!')
            break
